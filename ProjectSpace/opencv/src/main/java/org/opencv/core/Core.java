...
public class Core {
     ...
     * 0-based cluster index for the content_topic1_sample1 stored in the \(i^{th}\) row of the samples matrix.
     *
     * <b>Note:</b>
     * <ul>
     *   <li>
     ...
     * @param bestLabels Input/output integer array that stores the cluster indices for every content_topic1_sample1.
     ...
     * The \( L_{1}, L_{2} \) and \( L_{\infty} \) norm for the content_topic1_sample1 value \(r(-1) = \begin{pmatrix} -1 \\ 2 \end{pmatrix}\)
     ...
     * method.
     *
     * The content_topic1_sample1 below illustrates how to calculate a DFT-based convolution of two 2D real arrays:
     * <code>
     ...
     *     }
     * </code>
     * To optimize this content_topic1_sample1, consider the following approaches:
     * <ul>
     *   <li>
     ...
     * the convolution content_topic1_sample1 in dft description.
     */
