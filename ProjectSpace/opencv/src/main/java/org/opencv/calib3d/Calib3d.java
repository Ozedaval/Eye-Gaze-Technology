...
public class Calib3d {
     ...
     *   </li>
     *   <li>
     *    <b>CALIB_CB_ACCURACY</b> Up content_topic1_sample1 input image to improve sub-pixel accuracy due to aliasing effects.
     *   </li>
     *   <li>
     ...
     * a content_topic1_sample1 checkerboard optimized for the detection. However, any other checkerboard
     * can be used as well.
     ...
     * initUndistortRectifyMap (see the stereo_calib.cpp content_topic1_sample1 in OpenCV samples directory). When (0,0)
     ...
     *
     * See below the screenshot from the stereo_calib.cpp content_topic1_sample1. Some red horizontal lines pass through
