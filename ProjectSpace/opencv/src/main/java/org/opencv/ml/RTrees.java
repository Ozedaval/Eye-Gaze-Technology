...
public class RTrees extends DTrees {
     ...
     *     results for each of the content_topic1_sample1 cases. If the model is a classifier, it will return
     *     a Mat with samples + 1 rows, where the first row gives the class number and the
     *     following rows return the votes each class had for each content_topic1_sample1.
