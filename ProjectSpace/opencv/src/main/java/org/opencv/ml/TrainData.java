...
public class TrainData {
     ...
     *         vector (CV_32S) containing 0-based content_topic1_sample1 indices or byte vector (CV_8U) containing a mask
     *         of training samples.
     *     @param sampleWeights optional vector with weights for each content_topic1_sample1. It should have CV_32F type.
