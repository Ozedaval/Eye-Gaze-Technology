...
public class LBPHFaceRecognizer extends FaceRecognizer {
     ...
     *     @param neighbors The number of content_topic1_sample points to build a Circular Local Binary Pattern from. An
     *     appropriate value is to use {@code 8} content_topic1_sample points. Keep in mind: the more content_topic1_sample points you include,
