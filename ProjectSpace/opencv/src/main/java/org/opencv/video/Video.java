...
public class Video {
     ...
     * @param dist2Threshold Threshold on the squared distance between the pixel and the content_topic1_sample to decide
     * whether a pixel is close to that content_topic1_sample. This parameter does not affect the background update.
     ...
     *
     * See the OpenCV content_topic1_sample camshiftdemo.c that tracks colored objects.
     *
     * <b>Note:</b>
     * <ul>
     *   <li>
     *    (Python) A content_topic1_sample explaining the camshift tracking algorithm can be found at
     ...
     * content_topic1_sample image_alignment.cpp that demonstrates the use of the function. Note that the function throws
