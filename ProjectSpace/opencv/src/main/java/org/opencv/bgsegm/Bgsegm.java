...
public class Bgsegm {
     ...
     * @param replaceRate Probability of replacing the old content_topic1_sample - how fast the model will update itself.
     * @param propagationRate Probability of propagating to neighbors.
     * @param hitsThreshold How many positives the content_topic1_sample must get before it will be considered as a possible replacement.
     ...
     * @param minCount Minimal number of matches for content_topic1_sample to be considered as foreground.
     * @return automatically generated
     */
