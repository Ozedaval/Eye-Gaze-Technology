...
public class Detect {
    ...
    Mat detect(Mat frame) {
        ...
        List<Rect> eyeBoundaryOrigin = null;
        ...
        if (!listOfFaces.isEmpty()) {
            ...
            if (!isFirstPairOfIrisFound || needCalibration) {
                ...
                eyeBoundary = new ArrayList<>(2);
                eyeBoundaryOrigin = new ArrayList<>(2);
