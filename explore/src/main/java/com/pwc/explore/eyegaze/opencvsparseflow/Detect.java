...
public class Detect {
    ...
    Mat detect(Mat frame, CascadeClassifier faceCascade, CascadeClassifier eyesCascade, Net net) {
        /*Thread.dumpStack();*/
        ...
        // Detect the blob positions directly via DNN to find faces
        ...
        // Loop the detection objects that compared to confidence; low confidence detections may be neglected
